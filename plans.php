                           ...
                           <div class="row" >
                                ...
                                <div class="col-4">
                                        ...
                                        <div class="col-4 pt-3">
                                            ...
                                            <a href="<?php echo 'tel:'.$number ?>" class=" btn btn-warning btn-lg " style="border-radius: 20px !important;"><b class="text-light"><i class="fa fa-phone" aria-hidden="true"></i> &nbsp;<?php echo $number ?> </a></b>
                                            <a href="plans.php" class=" btn btn-warning btn-lg " style="border-radius: 20px !important;">plans &rtrif;</a>
                                        </div>
                               </div>
